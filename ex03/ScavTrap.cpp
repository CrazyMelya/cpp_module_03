...
{
	std::cout << "ScavTrap constructor " + name + " was called" << std::endl;
	this->setHitpoints(100);
	this->setEnergyPoints(50);
	this->setAttackDamage(20);
	this->guard = false;
...
{
	std::cout << "Copy ScavTrap constructor " + other.getName() + " was called" << std::endl;
	*this = other;
}

ScavTrap::~ScavTrap()
{
	std::cout << "ScavTrap destructor " + this->getName() + " was called" << std::endl;
}

ScavTrap &ScavTrap::operator=(ScavTrap const &other)
{
	std::cout << "Assigment ScavTrap operator was called" << std::endl;
